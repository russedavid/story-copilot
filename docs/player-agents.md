...
The first two experimental identities have been trained and exercised through the application. Their source-response loss improved, but a small blind review did not establish a consistent writing advantage over the base. A profile without an adapter remains a useful comparison. See the [recorded findings](validation.md#player-agents-20-september-2026) and the toolkit's [training results](https://github.com/russedavid/qwen-ttrpg/blob/main/docs/player-results.md).
